...
export const PORT = config.get('PORT').number().default(3001).value!;
...
export const DB_LOGGING = config.get('DB_LOGGING').boolean().default(false).value!;
export const DB_SYNCHRONIZE = config.get('DB_SYNCHRONIZE').boolean().default(false).value!;
